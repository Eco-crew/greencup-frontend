...
export default function PartnerMap({ partnerAddress }) {
  ...
  return (
    <>
      <div className="reuse_partner_manage_detail_partnermap_container">
        <div className="reuse_partner_manage_detail_partner_address">
          주소 : {partnerAddress}
        </div>
        <div id="reuse_partner_manage_detail_partner_map" ref={mapRef}></div>
      </div>
    </>
  );
}
