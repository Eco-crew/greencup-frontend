...
export default function HolidayRegularList({ weeklyOffDays }) {
  ...
  return (
    <>
      <div className="reuse-partner-manage-regular-holiday-list-container">
        <div className="reuse-partner-manage-regular-holiday-list">
          {weeklyOffDays &&
            Object.keys(realWeeklyOffDays).map((day) => (
              <div
                key={day}
                className="reuse-partner-manage-regular-holiday-element"
              >
                {realWeeklyOffDays[day].isHoliday == true ? (
                  <input className="reuse-partner-manage-regular-holiday-checkbox" type="checkbox" checked={true} readOnly />
                ) : (
                  <input className="reuse-partner-manage-regular-holiday-checkbox" type="checkbox" checked={false} readOnly/>
                )}
